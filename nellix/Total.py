...
if False:
        ...
        foo = _Do_Segmentation(ptcode,ctcode,basedir,seed_th=[650], show=True, normalize=True)
...
if True:
        ...
        foo = _Show_Model(ptcode,ctcode,basedir, meshWithColors=True,motion='amplitude',clim2=(0,1.5))
