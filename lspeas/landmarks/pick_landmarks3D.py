...
from lspeas.landmarks.landmarkselection import (saveLandmarkModel, LandmarkSelector, makeModelDynamic)
...
exceldir = select_dir(r'C:\Users\Maaike\Desktop',
                      ...
                      r'C:\Users\Freija Geldof\Documents\M2.2 stage MST Vaatchirurgie\Resultaten2')
                      #r'C:\Users\Freija\Documents\M2.2 stage MST Vaatchirurgie\Resultaten')
                      
dirsave = select_dir(r'G:\LSPEAS_ssdf_toPC\landmarks',
                     r'E:\Maaike-Freija\LSPEAS_landmarks\observer1\observer_freija_2\helemaal nieuwe laptop',
                     r'D:\Maaike-Freija\LSPEAS_landmarks\observer_maaike')

# Select location .mat file
matdir = select_dir(r'C:\Users\Freija Geldof\Documents\M2.2 stage MST Vaatchirurgie\Matlab\Inter observer correlation')
...
# Store algorithm coordinates to mat-file for data analysis in Matlab
mname3 = 'landmarkpoints_%s_%s_4.mat' % (ptcode, ctcode)
