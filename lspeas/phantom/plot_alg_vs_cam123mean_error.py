...
profilesA = [ 'ZA1', 'ZA2', 'ZA3', 'ZA3 STENT2']
profilesBxaxis = [0, 0.23, 0.37,0.71, 1.19, 1.26, 1.36] 
...
# save
f1.savefig(os.path.join(dirsave, 'abserrorgraphampl2.pdf'), papertype='a0', dpi=300)
